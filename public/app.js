...
function renderManualPasteView(extractedText, deckId, fileMeta = null) {
  ...
  step1.textContent = '1. Copy this prompt and paste it into ChatGPT, Claude.ai, Gemini, or any AI chat tool: (If your pdf is snapped notes, it is better to upload the pdf along with this prompt for better text extraction)';
